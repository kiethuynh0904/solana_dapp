    ...
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
          <div className="flex flex-row hidden sm:inline w-22 h-22 md:p-2 ml-10">
            ...
            <svg
              width="105%"
              height="24"
              viewBox="0 0 150 96" // DEFAULT 0 0 646 96
              fill="none"
            ...
            <span className="text-white font-semibold text-lg tracking-wide">DEMO</span>
            </div>
            </Link>
          </div>
